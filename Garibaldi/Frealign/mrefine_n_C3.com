...
set dfsig       = `grep dfsig mparameters_run | awk '{print $2}'`
...
/gpfs/home/rkhayat/Applications/frealign_v8.09_111001/bin_dist/frealign_v8.exe << eot >& ${data_input}_mrefine_n.log_${1}_${2}
