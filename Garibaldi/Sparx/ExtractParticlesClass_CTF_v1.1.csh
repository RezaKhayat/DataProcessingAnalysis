...
if ( $#argv != 6 ) then
  echo "ExtractParticles.csh <KeepClasses> <ClassAverages> <originalstack> <ctf_particles.sparx> <ctf_particles.frealign> <output>"
  echo "e.g. ./ExtractParticles.csh mT+KinParticles.classes out_bin2_sxmref_32/ ../ali_ctf_120.hed ctf_particles.sparx ctf_particles.frealign mT_Kin"
else 
    set SOURCE1 = $argv[1]
    set SOURCE2 = $argv[2]
    set SOURCE3 = $argv[3]
...
sxheader.py bdb:$SOURCE3 --zero --params=xform.align2d --params=xform.align3d
...
awk '{print $4*1000 " " $5*1000 " " $3}' ctf_frekept_1 > {$CTF_FRE}_keep.kept
rm -rf ctf_frekept_1
...
awk '{print $4*1000 " " $5*1000 " " $3}' ctf_frekept_2 > {$CTF_FRE}_excl.kept
rm -rf ctf_frekept_2
